...
Although it was primarily written for vhcd, this package has intentionally been
...
second layer alternatives, etc). Also, the current fill rate of blocks in valhallacoin
...
out earlier should be sufficient for current fill rate of valhallacoin's network.
...
[5] Source for the original vhcfeesim and estimator work:
https://github.com/matheusd/vhcfeesim_dev

[6] Source for the current vhcfeesim, using this module:
https://github.com/matheusd/vhcfeesim
*/
package fees
