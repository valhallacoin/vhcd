...
var helpDescsEnUS = map[string]string{
	...
	"debuglevel--synopsis": "Dynamically changes the debug logging level.\n" +
		...
		"The valid subsystems are AMGR, ADXR, BCDB, BMGR, VHCD, CHAN, DISC, PEER, RPCS, SCRP, SRVR, and TXMP.\n" +
	...
	"createrawsstx-amount--desc":  "The destination address as the key and the amount in VHC as the value",
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in VHC as the value",
	...
	"scriptpubkeyresult-addresses": "The Valhalla addresses associated with this script",
	"scriptpubkeyresult-commitamt": "The ticket commitment value if the script is for a staking commitment",

	// Vout help.
	"vout-value":        "The amount in VHC",
	...
	"decodescriptresult-addresses": "The Valhalla addresses associated with this script",
	...
	"getblock-verbosetx":   "Specifies that each transaction is returned as a JSON object and only applies if the verbose flag is true (vhcd extension)",
	...
	"getcurrentnet--synopsis": "Get Valhalla network the server is running on.",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in VHC/KB",
	...
	"infowalletresult-balance":         "The total Valhalla balance of the wallet",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in VHC/KB",
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in VHC/KB",
	...
	"getrawmempoolverboseresult-fee":              "Transaction fee in valhallacoin",
	...
	"gettxoutresult-value":         "The transaction amount in VHC",
	...
	"searchrawtransactions-address":     "The Valhalla address to search for",
	...
	"sendrawtransaction-allowhighfees": "Whether or not to allow insanely high fees (vhcd does not yet implement this parameter, so it has no effect)",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown vhcd.",
	"stop--result0":  "The string 'vhcd stopping.'",
	...
	"validateaddresschainresult-address": "The Valhalla address (only when isvalid is true)",

	// ValidateAddressCmd help.
	"validateaddress--synopsis": "Verify an address is valid.",
	"validateaddress-address":   "Valhalla address to validate",
	...
	"verifymessage-address":   "The Valhalla address to use for the signature",
	...
	// -------- Valhalla-specific help --------

	// EstimateFee help.
	"estimatefee--synopsis": "Returns the estimated fee in vhc/kb.",
	"estimatefee-numblocks": "(unused)",
	"estimatefee--result0":  "Estimated fee.",

	// EstimateSmartFee help.
	"estimatesmartfee--synopsis":     "Returns the estimated fee using the historical fee data in vhc/kb.",
	...
	"estimatesmartfee--result0":      "Estimated fee rate (in VHC/KB).",
	...
	// TicketFeeInfo help.
	"ticketfeeinfo--synopsis":            "Get various information about ticket fees from the mempool, blocks, and difficulty windows (units: VHC/kB)",
	...
	"ticketfeeinforesult-feeinfomempool": "Ticket fee information for all tickets in the mempool (units: VHC/kB)",
	"ticketfeeinforesult-feeinfoblocks":  "Ticket fee information for a given list of blocks descending from the chain tip (units: VHC/kB)",
	"ticketfeeinforesult-feeinfowindows": "Ticket fee information for a window period where the stake difficulty was the same (units: VHC/kB)",
...
var rpcResultTypes = map[string][]interface{}{
	...
	"decoderawtransaction":  {(*vhcjson.TxRawDecodeResult)(nil)},
	"decodescript":          {(*vhcjson.DecodeScriptResult)(nil)},
	"estimatefee":           {(*float64)(nil)},
	"estimatesmartfee":      {(*float64)(nil)},
	"estimatestakediff":     {(*vhcjson.EstimateStakeDiffResult)(nil)},
	...
	"getaddednodeinfo":      {(*[]string)(nil), (*[]vhcjson.GetAddedNodeInfoResult)(nil)},
	"getbestblock":          {(*vhcjson.GetBestBlockResult)(nil)},
	"generate":              {(*[]string)(nil)},
	"getbestblockhash":      {(*string)(nil)},
	"getblock":              {(*string)(nil), (*vhcjson.GetBlockVerboseResult)(nil)},
	"getblockchaininfo":     {(*vhcjson.GetBlockChainInfoResult)(nil)},
	"getblockcount":         {(*int64)(nil)},
	"getblockhash":          {(*string)(nil)},
	"getblockheader":        {(*string)(nil), (*vhcjson.GetBlockHeaderVerboseResult)(nil)},
	"getblocksubsidy":       {(*vhcjson.GetBlockSubsidyResult)(nil)},
	"getblocktemplate":      {(*vhcjson.GetBlockTemplateResult)(nil), (*string)(nil), nil},
	"getcfilter":            {(*string)(nil)},
	"getcfilterheader":      {(*string)(nil)},
	"getchaintips":          {(*[]vhcjson.GetChainTipsResult)(nil)},
	"getconnectioncount":    {(*int32)(nil)},
	"getcurrentnet":         {(*uint32)(nil)},
	"getdifficulty":         {(*float64)(nil)},
	"getstakedifficulty":    {(*vhcjson.GetStakeDifficultyResult)(nil)},
	"getstakeversioninfo":   {(*vhcjson.GetStakeVersionInfoResult)(nil)},
	"getstakeversions":      {(*vhcjson.GetStakeVersionsResult)(nil)},
	"getgenerate":           {(*bool)(nil)},
	"gethashespersec":       {(*float64)(nil)},
	"getheaders":            {(*vhcjson.GetHeadersResult)(nil)},
	"getinfo":               {(*vhcjson.InfoChainResult)(nil)},
	"getmempoolinfo":        {(*vhcjson.GetMempoolInfoResult)(nil)},
	"getmininginfo":         {(*vhcjson.GetMiningInfoResult)(nil)},
	"getnettotals":          {(*vhcjson.GetNetTotalsResult)(nil)},
	"getnetworkhashps":      {(*int64)(nil)},
	"getpeerinfo":           {(*[]vhcjson.GetPeerInfoResult)(nil)},
	"getrawmempool":         {(*[]string)(nil), (*vhcjson.GetRawMempoolVerboseResult)(nil)},
	"getrawtransaction":     {(*string)(nil), (*vhcjson.TxRawResult)(nil)},
	"getticketpoolvalue":    {(*float64)(nil)},
	"gettxout":              {(*vhcjson.GetTxOutResult)(nil)},
	"getvoteinfo":           {(*vhcjson.GetVoteInfoResult)(nil)},
	"getwork":               {(*vhcjson.GetWorkResult)(nil), (*bool)(nil)},
	"getcoinsupply":         {(*int64)(nil)},
	"help":                  {(*string)(nil), (*string)(nil)},
	"livetickets":           {(*vhcjson.LiveTicketsResult)(nil)},
	"missedtickets":         {(*vhcjson.MissedTicketsResult)(nil)},
	"node":                  nil,
	"ping":                  nil,
	"rebroadcastmissed":     nil,
	"rebroadcastwinners":    nil,
	"searchrawtransactions": {(*string)(nil), (*[]vhcjson.SearchRawTransactionsResult)(nil)},
	"sendrawtransaction":    {(*string)(nil)},
	"setgenerate":           nil,
	"stop":                  {(*string)(nil)},
	"submitblock":           {nil, (*string)(nil)},
	"ticketfeeinfo":         {(*vhcjson.TicketFeeInfoResult)(nil)},
	"ticketsforaddress":     {(*vhcjson.TicketsForAddressResult)(nil)},
	"ticketvwap":            {(*float64)(nil)},
	"txfeeinfo":             {(*vhcjson.TxFeeInfoResult)(nil)},
	"validateaddress":       {(*vhcjson.ValidateAddressChainResult)(nil)},
	"verifychain":           {(*bool)(nil)},
	"verifymessage":         {(*bool)(nil)},
	"version":               {(*map[string]vhcjson.VersionResult)(nil)},

	// Websocket commands.
	"loadtxfilter":                nil,
	"session":                     {(*vhcjson.SessionResult)(nil)},
...
func (c *helpCacher) rpcMethodHelp(method string) (string, error) {
	...
	help, err := vhcjson.GenerateHelp(method, helpDescsEnUS, resultTypes...)
	if err != nil {
		return "", err
	}
...
func (c *helpCacher) rpcUsage(includeWebsockets bool) (string, error) {
	...
	for k := range rpcHandlers {
		usage, err := vhcjson.MethodUsageText(k)
		if err != nil {
			return "", err
		}
