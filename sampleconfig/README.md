...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/valhallacoin/vhcd/sampleconfig)

Package sampleconfig provides a single constant that contains the contents of
the sample configuration file for vhcd.  This is provided for tools that perform
...
```bash
$ go get -u github.com/valhallacoin/vhcd/sampleconfig
```
