...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/valhallacoin/vhcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/valhallacoin/vhcd/blockchain/fullblocktests
```
