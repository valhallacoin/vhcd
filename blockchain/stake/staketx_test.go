...
func TestSStx(t *testing.T) {
	var sstx = vhcutil.NewTx(sstxMsgTx)
	...
	sstx = vhcutil.NewTxDeep(sstxMsgTx)
...
func TestSSTxErrors(t *testing.T) {
	...
	var sstxExtraInputs = vhcutil.NewTx(sstxMsgTxExtraInput)
	...
	var sstxExtraOutputs = vhcutil.NewTx(sstxMsgTxExtraOutputs)
	...
	var sstxUntaggedOut = vhcutil.NewTx(&tx)
	...
	var sstxInsOutsMismatched = vhcutil.NewTx(sstxMismatchedInsOuts)
	...
	var sstxBadVerOut = vhcutil.NewTx(sstxBadVersionOut)
	...
	var sstxNoNullData = vhcutil.NewTx(sstxNullDataMissing)
	...
	var sstxNullDataMis = vhcutil.NewTx(sstxNullDataMisplaced)
	...
	var sstxWrongPKHLength = vhcutil.NewTx(&tx)
	...
	var sstxWrongPrefix = vhcutil.NewTx(&tx)
...
func TestSSGen(t *testing.T) {
	var ssgen = vhcutil.NewTx(ssgenMsgTx)
	...
	ssgen = vhcutil.NewTxDeep(ssgenMsgTx)
	ssgen.SetTree(wire.TxTreeStake)
	ssgen.SetIndex(0)
...
func TestSSGenErrors(t *testing.T) {
	...
	var ssgenExtraInputs = vhcutil.NewTx(ssgenMsgTxExtraInput)
	...
	var ssgenExtraOutputs = vhcutil.NewTx(ssgenMsgTxExtraOutputs)
	...
	var ssgenStakeBaseWrong = vhcutil.NewTx(ssgenMsgTxStakeBaseWrong)
	...
	var ssgenWrongTreeIns = vhcutil.NewTx(&tx)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssgenTxBadVerOut = vhcutil.NewTx(ssgenMsgTxBadVerOut)
	...
	var ssgenWrongZeroethOut = vhcutil.NewTx(ssgenMsgTxWrongZeroethOut)
	...
	var ssgenWrongDataPush0Length = vhcutil.NewTx(&tx)
	...
	var ssgenWrongNullData0Prefix = vhcutil.NewTx(&tx)
	...
	var ssgenWrongFirstOut = vhcutil.NewTx(ssgenMsgTxWrongFirstOut)
	...
	var ssgenWrongDataPush1Length = vhcutil.NewTx(&tx)
	...
	var ssgenWrongNullData1Prefix = vhcutil.NewTx(&tx)
	...
	var ssgentestGenOutputUntagged = vhcutil.NewTx(&tx)
...
func TestSSRtx(t *testing.T) {
	var ssrtx = vhcutil.NewTx(ssrtxMsgTx)
...
func TestIsSSRtxErrors(t *testing.T) {
	...
	var ssrtxTooManyInputs = vhcutil.NewTx(ssrtxMsgTxTooManyInputs)
	...
	var ssrtxTooManyOutputs = vhcutil.NewTx(ssrtxMsgTxTooManyOutputs)
	...
	// ---------------------------------------------------------------------------
	// Test for bad version of output.
	var ssrtxTxBadVerOut = vhcutil.NewTx(ssrtxMsgTxBadVerOut)
	...
	var ssrtxTestRevocOutputUntagged = vhcutil.NewTx(&tx)
	...
	var ssrtxWrongTreeIns = vhcutil.NewTx(&tx)
