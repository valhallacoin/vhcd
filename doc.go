...
/*
vhcd is a full-node Valhalla implementation written in Go.

The default options are sane for most users.  This means vhcd will work 'out of
...
parsed when vhcd starts up.  By default, the configuration file is located at
~/.vhcd/vhcd.conf on POSIX-style operating systems and %LOCALAPPDATA%\vhcd\vhcd.conf
...
Application Options:
  ...
  -P, --rpcpass=            Password for RPC connections
      ...
      --rpclisten=          Add an interface/port to listen for RPC connections
                            (default port: 9209, testnet: 19209)
  ...
  -d, --debuglevel=         Logging level for all subsystems {trace, debug,
      ...
      --minrelaytxfee=      The minimum transaction fee in VHC/kB to be
      ...
      --altdnsnames:        Specify additional dns names to use when
                            ...
                            [supports VHCD_ALT_DNSNAMES environment variable]
