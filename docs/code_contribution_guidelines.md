...
reason, the vhcd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire vhcd
...
One of the major design goals of all core vhcd packages is to aim for complete
...
- If a commit modifies a component in any of the packages besides the main
  package use the package name as the commit prefix (eg. `vhcjson`).
...
contributions.  This is how to get your changes into vhcd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/valhallacoin/vhcd/graphs/contributors)!
...
[ISC license](https://github.com/valhallacoin/vhcd/blob/master/LICENSE).  This is
the same license as all of the code in the vhcd suite.
