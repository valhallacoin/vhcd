...
// for vhcd and other utilities provided in the same repository.
package version
...
var (
	...
	// build process with:
	// '-ldflags "-X github.com/valhallacoin/vhcd/internal/version.PreRelease=foo"'
	...
	// build process with:
	// '-ldflags "-X github.com/valhallacoin/vhcd/internal/version.BuildMetadata=foo"'
